...
//	    	}
		...
		@Test(priority=9)
		public void trs()throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, 30); 
		try {
  		    WebElement trs= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//img[@src='/viewer/assets/images/colorsvg/trsinteraction.svg']")));
  		    trs.click();
  		    System.out.println("TRS selected successfully.");
  		    Thread.sleep(2000);
  		} catch (Exception e) {
  		    System.out.println("TRS option is not open: " + e.getMessage());
  		}
		Thread.sleep(3000);
		try {
  		    WebElement cls= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//img[@src='/viewer/assets/images/colorsvg/cancel.svg']")));
  		    cls.click();
  		    System.out.println("TRS closed successfully.");
  		    Thread.sleep(2000);
  		} catch (Exception e) {
  		    System.out.println("TRS option is not close: " + e.getMessage());
  		}
		}	
		@Test(priority=10)
		public void delete() throws InterruptedException
		{
			...
			actions.moveToElement(canvas, offsetX, offsetY)
			        .click()
			        .perform();
			Thread.sleep(2000);
		 clickElementByXpath("(//i[@role='presentation'])[11]", "node4");
			...
			clickElementByXpath("//img[@src='/viewer/assets/images/colorsvg/deleted.svg']", "Delete button");
			clickElementByXpath("//button[text()='Delete']", "Delete option");
			clickElementByXpath("//img[@src='/viewer/assets/images/colorsvg/saved.svg']", "save");
			clickElementByXpath("//a[@title='Close']", "close");
			clickElementByXpath("//a[@title='Back']", "Back ");
			System.out.println("*******************TRS data deleted successfully**************************");
		}
